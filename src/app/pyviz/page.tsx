...
export default function PyVizPage() {
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-6">Python Visualization</h1>
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        {plotData && (
          <div>
            ...
            <div className="mt-4">
              <h3 className="text-lg font-semibold mb-2">Raw Data Sample:</h3>
